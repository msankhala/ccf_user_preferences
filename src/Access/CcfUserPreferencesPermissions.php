...
namespace Drupal\ccf_user_preferences\Access;
...
/**
 * Provides dynamic permissions for Ccf user preferences of different types.
 *
 * @ingroup ccf_user_preferences
 *
 */
class CcfUserPreferencesPermissions{
   ...
   *
   * @return array
   *   The CcfUserPreferences by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (CcfUserPreferences::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\ccf_user_preferences\Entity\CcfUserPreferences $type
   *   The CcfUserPreferences type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(CcfUserPreferences $type) {
    $type_id = $type->id();
